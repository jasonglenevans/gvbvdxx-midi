	...
	main.build(a,b,true,async function () {
		...
		http.get(download32url,async function (response) {
			...
			response.on("end", async function () {
				...
				fs.writeFileSync("./app-electron/resources/app/package.json",JSON.stringify({name:packageJSON.name,main:"electron-main.js"}));
				var defaultName = "Unnamed Application";
				if (packageJSON.appName) {
					defaultName = packageJSON.appName;
				}
				fs.writeFileSync("./app-electron/resources/app/electron-main.js",[
